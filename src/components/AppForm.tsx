import { Plus, X, Calculator, Coffee, Trash2 } from "lucide-react";
...
function AppForm() {
  ...
  const handleUpdateExpense = (id: number, field: string, value: string) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 p-2 sm:p-4 text-gray-900">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="bg-white rounded-t-xl shadow-sm p-3 sm:p-4 border-b border-gray-200">
        ...
        <div className="bg-white shadow-lg rounded-b-xl">
          ...
          <div className="p-3 sm:p-5">
                      ...
                      >
                        <td className="px-1 sm:px-2 py-2 sm:py-3">
                          <select
                            ...
                            className="w-full px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white"
                          >
                        ...
                        <td className="px-1 sm:px-3 py-2">
                          <div className="relative">
                            <input
                              ...
                              step="0.01"
                              min="0"
                              className="w-full px-1.5 sm:px-2 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                            />
                          </div>
                        </td>
                        <td className="px-1 py-2 sm:py-3 text-center">
                          <button
                            ...
                            className="p-1.5 sm:p-2 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 mt-4 sm:mt-6">
              ...
              {/* Total Section */}
              <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white p-3 sm:p-4 rounded-lg shadow-lg">
                <div className="flex items-center gap-2 mb-1">
                  <Calculator size={16} className="sm:w-[18px] sm:h-[18px]" />
                  <span className="text-xs sm:text-sm font-medium">
                    Сумма на конец дня
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center gap-4">
              <button
                onClick={handleSave}
                disabled={isLoading}
                className="px-8 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors shadow-md hover:shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:cursor-pointer"
              >
                {isLoading ? (
                  <>
